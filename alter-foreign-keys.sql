...
ALTER TABLE ad_auctions ALTER COLUMN average_winning_bid TYPE bigint;
...
ALTER TABLE awsdms_ddl_audit ALTER COLUMN c_oid TYPE bigint;
...
ALTER TABLE ad_auctions ALTER COLUMN current_bid TYPE bigint;
ALTER TABLE ad_bidding ALTER COLUMN current_bid TYPE bigint;
...
ALTER TABLE raffle_drop_entry_orders ALTER COLUMN entry_id TYPE bigint;
...
ALTER TABLE listing_bpo_review_record ALTER COLUMN listing_id TYPE bigint;
...
ALTER TABLE raffle_drop_entry_orders ALTER COLUMN order_id TYPE bigint;
...
ALTER TABLE ad_auctions ALTER COLUMN previous_bid TYPE bigint;
...
ALTER TABLE offers ALTER COLUMN product_id TYPE bigint;
...
ALTER TABLE ad_charges ALTER COLUMN user_id TYPE bigint;
...
ALTER TABLE bid_without_payment_info ALTER COLUMN user_id TYPE bigint;
...
ALTER TABLE offers ALTER COLUMN user_id TYPE bigint;
...
ALTER TABLE user_follows_counts ALTER COLUMN user_id TYPE bigint;
...
-- Had to add manually - missed by the query
ALTER TABLE "Lives" ALTER COLUMN user_id TYPE bigint;